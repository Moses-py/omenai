...
import ProductBox, { ProductBoxTypes } from "./components/ProductBox";
...
export default async function page({ params }: { params: { id: string } }) {
  const artworkDetails: ProductBoxTypes = await fetchSingleArtwork(
    decodeURIComponent(params.id)
  );
  // console.log(artworkDetails.data.medium);
  return (
    <div className="">
      <DesktopNavbar />

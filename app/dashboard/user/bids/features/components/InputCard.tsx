...
export const InputCard = (props: Props) => {
  ...
  return (
    <div className="flex flex-col gap-3">
      <label htmlFor={id} className="text-base font-normal text-dark">
        {label}
      </label>
      <div className={clsx("flex items-center justify-between py-1 px-1")}>
        <input
          ...
          className={clsx(
            ...
            } border-b-dark/20 focus:ring-0 focus:outline-none disabled:cursor-not-allowed focus:border-b-dark ring-0 text-dark placeholder:text-secondary/40 p-2`,
            className
          )}
          {...rest}
        />

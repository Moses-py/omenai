  ...
  return (
    <AnimatePresence key={id}>
      ...
      >
        ...
        <input
          type={type}
          className=" border-0 focus:ring-0 border-b-[1px] px-0 border-b-primary outline-none focus:outline-none focus:border-b-secondary transition-all duration-200 ease-in-out ring-0 placeholder:text-secondary/40 py-2"
